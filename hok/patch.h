...
NSString* ooOoooOO(char* machoPath, uint64_t vaddr, char* patch)
{
...
#define HOOK(x, y, z) \
NSString* result_##y = ooOOooOO(("Frameworks/UnityFramework.framework/UnityFramework"), x, nullptr); \
if (result_##y) { \
